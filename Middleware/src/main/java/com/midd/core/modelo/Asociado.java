...
public class Asociado implements Serializable{
	...
	public String toString() {
		return "Asociado [id_numero_Ultimatix=" + id_numero_Ultimatix + ", clave=" + clave + ", nombre=" + nombre
				+ ", apellido=" + apellido + ", telefono=" + telefono + ", correo=" + correo + ", rol=" + rol + "]";
	}
